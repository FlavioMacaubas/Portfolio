...
- Linguagem principal: **Not specified**
- Tópicos: ai, data-engineering, machine-learning, portfolio
...
~~~bash
git clone https://github.com/FlavioMacaubas/Portfolio.git
cd Portfolio
...
Portfolio/
├── README.md
└── (hub com links para os projetos)
~~~
